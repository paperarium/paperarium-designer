...
//       vks::initializers::mappedMemoryRange(); mappedRange.memory = *memory;
...
//   VkBufferCreateInfo bufferCreateInfo =
//       vks::initializers::bufferCreateInfo(usageFlags, size);
//   VK_CHECK_RESULT(vkCreateBuffer(m_logical_device, &bufferCreateInfo,
//   nullptr,
//                                  &buffer->buffer));
...
//       getMemoryType(memReqs.memoryTypeBits, memoryPropertyFlags);
//   VK_CHECK_RESULT(
//       vkAllocateMemory(m_logical_device, &memAlloc, nullptr,
//       &buffer->memory));
