...
inline VkDescriptorSetLayoutCreateInfo descriptorSetLayoutCreateInfo(
    VkDescriptorSetLayoutBinding const* pBindings, uint32_t bindingCount) {
...
inline VkPipelineLayoutCreateInfo pipelineLayoutCreateInfo(
    VkDescriptorSetLayout const* pSetLayouts, uint32_t setLayoutCount = 1) {
...
inline VkDescriptorSetAllocateInfo descriptorSetAllocateInfo(
    VkDescriptorPool descriptorPool, VkDescriptorSetLayout const* pSetLayouts,
...
inline VkPipelineDynamicStateCreateInfo pipelineDynamicStateCreateInfo(
    VkDynamicState const* pDynamicStates, uint32_t dynamicStateCount,
...
inline VkPipelineDynamicStateCreateInfo pipelineDynamicStateCreateInfo(
    std::vector<VkDynamicState> const& pDynamicStates,
    VkPipelineDynamicStateCreateFlags flags = 0) {
  VkPipelineDynamicStateCreateInfo pipelineDynamicStateCreateInfo{};
  pipelineDynamicStateCreateInfo.sType =
      VK_STRUCTURE_TYPE_PIPELINE_DYNAMIC_STATE_CREATE_INFO;
...
inline VkSpecializationInfo specializationInfo(
    uint32_t mapEntryCount, VkSpecializationMapEntry const* mapEntries,
