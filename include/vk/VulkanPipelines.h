...
class VULKANENGINE_EXPORT_API VulkanPipelines {
 public:
  ...
  void createBasePipelineInfo(VkPipelineLayout const& pipelineLayout,
                              VkRenderPass const& renderPass);
  void createPipeline(VulkanShader* shader,
                      VkPolygonMode mode = VK_POLYGON_MODE_FILL);
  void createPipeline(VulkanShader* shader, VkRenderPass renderPass,
                      VkPolygonMode mode = VK_POLYGON_MODE_FILL);
  void createPipeline(std::shared_ptr<VulkanShader> shader,
                      VkPolygonMode mode = VK_POLYGON_MODE_FILL) {
