...
VulkanShader::~VulkanShader() {
  ...
  for (auto &shaderModule : m_shaderModules) {
    VK_SAFE_DELETE(shaderModule, vkDestroyShaderModule(m_context->getDevice(), shaderModule, nullptr));
  }
}
 ...
 */
VkPipelineShaderStageCreateInfo VulkanShader::loadShader(const std::string &fileName, const VkShaderStageFlagBits &stage) {
